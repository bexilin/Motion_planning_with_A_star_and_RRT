...
if __name__ == "__main__":
    ...
    originalpath, smoothpath = RRT.RRT_connect(startconfig,goalconfig,env,robot,GetEETransform) #put your final path in this variable

    x = []
    for i in originalpath:
        transform = GetEETransform(robot, [i[0], i[1], i[2], i[3], i[4], i[5]])
        x.append(env.plot3(points=numpy.array((transform[0][3], transform[1][3], transform[2][3])), pointsize=10.0,
